...
<footer class="footer">
  ...
  <div class="footer-section">
    <h3>Ayuda</h3>
    <ul>
      <li><a href="preguntas-frecuentes.html"><img src="images/Preguntas.png" alt="Preguntas" class="footer-list-icon"> <span class="footer-list-text">Preguntas frecuentes</span></a></li>
      <li><a href="como-conectar-bocina-bluetooth.html"><img src="images/Categorias.png" alt="" class="footer-list-icon"> <span class="footer-list-text">Guía: conectar bocina Bluetooth</span></a></li>
      <li><a href="como-vender-en-sonic-box.html"><img src="images/Vender.png" alt="Vender" class="footer-list-icon"> <span class="footer-list-text">Cómo vender en Sonic Box</span></a></li>
    </ul>
  </div>
  <div class="footer-section">
    <h3>Contacto</h3>
    <ul>
      ...
      <li><a href="https://maps.app.goo.gl/VYN8dC4GkS6CD6DE6" target="_blank" rel="noopener noreferrer"><img src="images/Ubicacion.png" alt="Ubicación" class="footer-list-icon"> <span class="footer-list-text">Ubicación</span></a></li>
    </ul>
  </div>
